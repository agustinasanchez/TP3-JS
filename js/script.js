...
let salePrices = sale => {
    salePrices = 0
    sale.forEach(e => {
        const component = e.prices.find (({item}) => e === item)
        salePrices = salePrices + component.price
        return salePrices 
    });
 
 const venta = ["Monitor GPRS 3000", "Motherboard ASUS 1500"];
 
 console.log (salePrices(venta));
}
